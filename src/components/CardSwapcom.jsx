    ...
    <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-10 px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
      ...
      <div className="w-full lg:w-1/2 text-white space-y-4 sm:space-y-6 max-w-2xl">
        ...
        <h2 className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 leading-relaxed text-center lg:text-left">
          Detail-oriented and self-motivated full-stack web developer with strong foundations in front-end and back-end.
          Experienced delivering freelance projects using modern tech stacks and open-source frameworks. Focused on
          building responsive, scalable, and efficient applications with attention to performance and user experience.
          <br />
          <br />
          Core stack:
          <span className="text-green-400 font-bold"> HTML, CSS, JavaScript, React, Vue, Angular, Tailwind, Bootstrap</span> on the front-end and
          <span className="text-green-400 font-bold"> PHP (Laravel), Node.js/Express, Python, Java</span> on the back-end with
          <span className="text-green-400 font-bold"> MySQL, MongoDB, SQL</span> databases.
          Comfortable with <span className="text-white font-semibold">Git, Linux, Docker, JWT, OAuth</span>.
        </h2>
      </div>
