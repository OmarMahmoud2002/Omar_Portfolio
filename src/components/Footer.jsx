...
const Footer = () => {
  const handleContactClick = (e) => {
    e.preventDefault();
    const email = 'omarmahmoud.devv@gmail.com';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 font-mono text-xs sm:text-sm">
              ...
              <div className="flex items-center space-x-2 text-gray-300 hover:text-green-400 transition-colors cursor-pointer">
                ...
                <a 
                  href="https://www.linkedin.com/in/omarmahmoud2002"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              type="button"
              aria-label="Send email to Omar Mahmoud"
              role="button"
              tabIndex={0}
            >
          ...
          <div className="font-mono text-xs sm:text-sm text-gray-400 space-y-2">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center space-y-2 md:space-y-0">
              <div className="text-center md:text-left">
                <span className="text-green-400">root@system:~$</span> echo "Omar Mahmoud Ahmed © 2025 All rights reserved"
              </div>
